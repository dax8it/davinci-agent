...
description: Select and tighten spoken introductions, stage banter, or interviews in DaVinci Resolve using word timings, waveforms, and listening. For live music camera selection and venue showcase assemblies, use edit-davinci-video instead.
---
...
2. Review complete spoken thoughts and select usable deliveries. Remove abandoned or redundant speech only within the requested scope; retain meaningful pauses, crowd interaction, and context. Do not automatically choose the last take.
...
Do not apply dialogue pacing to an entire performance or rebuild the user's existing edit merely to impose a workflow order.
